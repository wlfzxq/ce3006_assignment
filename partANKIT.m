...
for i=80:160:163760
    ...
    sum1=0;
    for j=i:i+160
        sum1=sum1+OOK_filtered(i);
    end
    sum1=sum1/160;
    if (OOK_filtered(i)>=1)
       OOK_decoded(counter)=1;
    end
    if (OOK_filtered(i)<1)
       OOK_decoded(counter)=0;
    end
